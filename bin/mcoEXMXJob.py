...
if __name__ == '__main__':
    ...
    job = MCOEXMXJob(particleList=p,numberIterations=numberIterations,\
                     ...
                     wedgeInfo=w,binning=binning,sampleInformation=sample,numberClasses=numberClasses,\
                     endThreshold=endThreshold,symmetry = sym,doAlignment = False,frmBandwidth = None)
