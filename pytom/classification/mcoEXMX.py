...
#                    exMaxJob.setPreprocessing(preProcessing)
            ...
            if doAdaptiveResolution:
                ...
                for classIterator in range(len(particleLists)):
                    ...
                    resolution = classList.determine_resolution(criterion=0.5,numberBands = cubeSize / 2,mask=exMaxJob.getMask(),verbose=False,plot='',keepHalfsetAverages = False,halfsetPrefix='class' + str(className), parallel=True)
