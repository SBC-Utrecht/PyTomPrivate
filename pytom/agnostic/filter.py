...
def create_symmetric_wedge(
    angle1, angle2, cutoffRadius, sizeX, sizeY, sizeZ, smooth, rotation=None
):
    ...
    if rotation is None:
        ...
        z, y, x = xp.meshgrid(
            xp.abs(xp.arange(-sizeY // 2 + sizeY % 2, sizeY // 2 + sizeY % 2, 1.0)),
            xp.abs(xp.arange(-sizeX // 2 + sizeX % 2, sizeX // 2 + sizeX % 2, 1.0)),
            xp.arange(0, sizeZ // 2 + 1, 1.0),
        )
