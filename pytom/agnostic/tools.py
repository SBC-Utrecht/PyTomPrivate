...
def create_sphere(size, radius=-1, sigma=0, num_sigma=2, center=None, gpu=False) -> xpt.NDArray:
...
def create_circle(size, radius=-1, sigma=0, num_sigma=3, center=None) -> xpt.NDArray:
    """Create a 3D sphere volume.
