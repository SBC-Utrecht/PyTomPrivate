...
def toProjectionStackFromAlignmentResultsFile( alignmentResultsFile, weighting=None, lowpassFilter=0.9, binning=None, num_procs=1):
    ...
    from pytom.basic.datatypes import fmtAR, headerAlignmentResults, datatype, datatypeAR
    from pytom.reconstructionStructures import Projection, ProjectionList
    from pytom_numpy import vol2npy
